...
const SequenceB1: React.FC = () => {
  ...
  async function playSoundA() {   
    try{    
      ...
      const { sound } = await Audio.Sound.createAsync(({uri:'http://simbiosecode.store:8083/a1.mp3'}));  
      setSound(sound);        
  ...
  async function playSoundB() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://simbiosecode.store:8083/b1.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      // setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundC() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/c1.mp3'}));    
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundD() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/d1.mp3'}));   
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundE() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/e1.mp3'}));    
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundF() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/f1.mp3'}));   
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundG() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/g1.mp3'})); 
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundH() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/h1.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundI() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/i1.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundJ() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/j1.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundK() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/k1.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundL() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/l1.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundM() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/m1.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundN() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/n1.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundO() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/o1.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundP() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/p1.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundQ() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/q1.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundR() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/r1.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundS() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/s1.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundT() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/t1.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
   ...
   async function playSoundU() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/u1.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundV() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/v1.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundX() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/x1.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundZ() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/Z1.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
