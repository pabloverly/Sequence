...
const SequenceB2: React.FC = () => {
  ...
  async function playSoundA() {   
    try{    
      ...
      const { sound } = await Audio.Sound.createAsync(({uri:'http://simbiosecode.store:8083/a2.mp3'}));  
      setSound(sound);        
  ...
  async function playSoundB() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://simbiosecode.store:8083/b2.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      // setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundC() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/c2.mp3'}));    
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundD() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/d2.mp3'}));   
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundE() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/e2.mp3'}));    
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundF() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/f2.mp3'}));   
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundG() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/g2.mp3'})); 
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundH() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/h2.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundI() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/i2.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundJ() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/j2.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundK() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/k2.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundL() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/l2.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundM() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/m2.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundN() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/n2.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundO() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/o2.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundP() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/p2.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundQ() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/q2.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundR() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/r2.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundS() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/s2.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundT() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/t2.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
   ...
   async function playSoundU() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/u2.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundV() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/v2.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundX() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/x2.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
  ...
  async function playSoundZ() { 
    try{
      const { sound } = await Audio.Sound.createAsync(({uri:'http://192.168.1.65:8081/Z2.mp3'}));  
      setSound(sound);   
      await sound.playAsync(); 
      setTimeout(() => { sound.unloadAsync();},  +pedal);     
    }
